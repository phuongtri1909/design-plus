        ...
        <div class="row">
            <div class="col-md-offset-1 col-md-12">
                <div class="panel pb-2">
                    ...
                    <form id="formCreateUser" action="{{ route('store.user') }}" method="POST" enctype="multipart/form-data" class="mb-3">
                        @csrf
                        <div class="row">
                            ...
                            <div class="form-group mb-2 col-12 col-md-6">
                                <div class="mx-2">
                                    <input id="full_name" type="text" class="input-create form-control @error('full_name') is-invalid @enderror" name="full_name" value="{{old('full_name')}}" autocomplete="full_name" placeholder="Họ và tên">
                            ...
                            <div class="form-group mb-2 col-12 col-md-6">
                                <div class="mx-2">
                                    <input id="username" type="username" class="input-create form-control @error('username') is-invalid @enderror" name="username" value="{{old('username')}}" autocomplete="username" placeholder="Tài khoản">
                            ...
                            <div class="form-group mb-2 col-12">
                                <div class="mx-2">
                                    <select id="status" class="text-left form-control input-create @error('status') is-invalid @enderror" name="status" >
                                        ...
                                        <option {{ old('status')  == 'active' ? 'selected' : '' }} value="active">Kích hoạt</option>
                                        <option {{ old('status')  == 'inactive' ? 'selected' : '' }} value="inactive">Không kích hoạt</option>
                                    </select>
