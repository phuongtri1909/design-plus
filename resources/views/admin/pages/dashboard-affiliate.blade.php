                    ...
                    <div class="panel-heading">
                        <div class="card">
                            ...
                            <div class="infomation mx-5">
                                <p class="text-dark"><span class="font-weight-bold">Tài khoản:</span> {{ auth()->user()->username }}</p>
                                <p class="text-dark"><Span class="font-weight-bold">Ngày đăng ký:</Span> {{ auth()->user()->created_at }}</p>
                                <p class="text-dark"><Span class="font-weight-bold">Ngày cập nhật:</Span> {{ auth()->user()->updated_at }}
                                </p>
                    ...
                    <div class="panel-heading">
                        <div class=" mt-3">   
                            <div class="card">
                                ...
                                <div id="pagination">
                                    {{ $get_posts->links('vendor.pagination.custom') }}
                                </div>
