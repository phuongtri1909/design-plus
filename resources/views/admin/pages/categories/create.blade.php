    ...
    <div class="row">
        <div class="col-md-offset-1 col-md-12">
            <div class="panel pb-2">
                ...
                <form id="formCreateCategory" action="{{ route('categories.store') }}" method="POST" enctype="multipart/form-data" class="mb-3">
                    @csrf
                    <div class="form-group w-100 mb-2">
                        <div class="mx-5">
                            <input id="name" type="text" class="input-create form-control @error('name') is-invalid @enderror" name="name" value="{{old('name')}}" autocomplete="name" placeholder="Tên thể loại">
