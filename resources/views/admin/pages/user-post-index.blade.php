                                ...
                                @foreach ($userPost as $user)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <p><span class="font-weight-bold">Đã lấy:</span> <span class="badge bg-primary rounded-pill">{{ $user->count_post }}  bài</span></p>
                                        ...
                                        <td>
                                            <ul class="action-list">
                                                ...
                                                <li><a href="{{ route('user.post.show',$user->id) }}" data-tip="Xem"><i class="fa-regular fa-eye text-success"></i></a></li>
                                            </ul>
                                        </td>
                                    </tr>
                                @endforeach
